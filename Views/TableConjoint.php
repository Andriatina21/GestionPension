...
<head>
    ...
    <title>Table des conjoints</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="../Controller/TableConjointController.php" class="black-contrast">Conjoint</a>
        <a href="../Controller/TablePayerController.php">Payer</a>
    </div>
    
      
        <div class="table-container">
            <h1> Informations Personnels des Conjoints</h1>
            <table class="tableau">
                <thead>
                    <tr>
                        <th>num_Pension</th>
                        <th>NomConjoint</th>
                        <th>PrenomConjoint</th>
            ...
            <div class="contour-bouton">
                <a href="../Controller/ConjointController.php" class="btn btn-secondary" ><img src="../Views/icon/ajouter.png" alt=""></a>
            </div>
        </div>
</body>
</html>
